...
<body>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="../index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>New Submission</a></div>
        </div>
        <!--End-breadcrumbs-->
        <?php
        ...
        <div class="container-fluid">
            <div id="loginbox">
                ...
                if (isset($_POST['group'])) {
                    ...
                    $_SESSION['id_group'] = $_POST['group'];
                    if (file_exists('./Classes/' . $_POST['group']))
                        header('Location: CompilersIndex.php');
                    else
